...
const styles = StyleSheet.create({
  ...
  backText: { fontFamily: 'SourceCodePro-Regular', fontSize: 11, color: 'rgba(255,255,255,0.6)', letterSpacing: 2 },
  title: { fontFamily: 'DMSerifDisplay-Regular', fontSize: 22, color: '#ffffff' },
  subtitle: { fontFamily: 'SourceCodePro-Regular', fontSize: 10, color: 'rgba(255,255,255,0.4)', letterSpacing: 2, marginTop: 4 },
  section: { paddingHorizontal: 20, marginBottom: 28 },
  sectionTitle: { fontFamily: 'SourceCodePro-Medium', fontSize: 10, color: 'rgba(255,255,255,0.3)', letterSpacing: 2, marginBottom: 12 },
  ...
  factorName: { fontFamily: 'Inter-SemiBold', fontSize: 14, color: '#ffffff' },
  factorWeight: { fontFamily: 'SourceCodePro-Regular', fontSize: 10, color: 'rgba(255,255,255,0.4)', letterSpacing: 1 },
  ...
  confidenceLabel: { fontFamily: 'SourceCodePro-Bold', fontSize: 11, letterSpacing: 1 },
